...
Usage:
    ...
    python generate_training_data.py --docs_dir ../../sample_docs --output ../data/processed/training_data.jsonl
"""
...
async def main():
    ...
    parser.add_argument("--output", type=str, default="../data/processed/training_data.jsonl",
