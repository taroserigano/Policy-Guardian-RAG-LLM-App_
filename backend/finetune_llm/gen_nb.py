...
notebook = {
    ...
    "cells": [
        ...
        {"cell_type": "code", "metadata": {}, "source": ["trainer.save_model('./policy-llama/final')\n", "tokenizer.save_pretrained('./policy-llama/final')\n", "print('Saved!')"], "execution_count": None, "outputs": []},
        {"cell_type": "markdown", "metadata": {}, "source": ["## Download Model"]},
        {"cell_type": "code", "metadata": {}, "source": ["!zip -r policy-llama.zip ./policy-llama/final\n", "files.download('policy-llama.zip')"], "execution_count": None, "outputs": []},
    ]
}
